...
export const MODEL_OPTIONS_BY_PROVIDER = {
  ...
  opencode: [
    { slug: "github-copilot/gpt-5.4", name: "GPT-5.4" },
    { slug: "github-copilot/gpt-5.4-mini", name: "GPT-5.4 Mini" },
    { slug: "github-copilot/claude-sonnet-4.5", name: "Claude Sonnet 4.5" },
    { slug: "github-copilot/claude-opus-4.6", name: "Claude Opus 4.6" },
  ],
...
export const MODEL_SLUG_ALIASES_BY_PROVIDER = {
  ...
  opencode: {
    ...
    "gpt-5.4-mini": "github-copilot/gpt-5.4-mini",
